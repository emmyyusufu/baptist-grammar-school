      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#">Signed in as Emmanuel</a></li>
            <li><a href="./login.html" style="color: #09a5db;">Logout</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
    </nav>
         ...
         <div class="container" style="margin-top: 50px; margin-bottom: 25px;">
             <div class="row">
                 ...
                 <div class="col-xs-12 col-sm-4 col-md-3">
                     <div class="longCard">
                         <img src="img/ey.jpg" alt="" height="262.5" width="100%" style="border-radius: 5px;" class="img-responsive">
                         <div class="persona" style="text-align: left">
                             <h2 style="font-size: 25px !important;"><strong>Emmanuel Yusufu</strong></h2>
                             <span style="font-size: 16px !important;">Full Stack JavaScript Developer <span>
                         </div>
                         <p style="margin-bottom: 10px;"></p>
                         <u><a href="#" style="color: #1E344C">Edit profile</a></u>
                         <hr>
                         <p><i class="fa fa-map-marker"></i> Ikorodu, Nigeria</p>
                         <p><i class="fa fa-envelope-open"></i> emmayusufu@gmail.com</p>
